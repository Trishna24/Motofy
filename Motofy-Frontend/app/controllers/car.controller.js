...
angular.module('motofyApp')
  .controller('CarController', ['ApiService', 'AppConfig', '$window', '$location', '$routeParams', '$timeout', '$scope', function(ApiService, AppConfig, $window, $location, $routeParams, $timeout, $scope) {
    var vm = this;
